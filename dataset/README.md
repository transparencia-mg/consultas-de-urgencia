Conjunto de dados referentes a unidade de medida que representa a quantidade de consultas de urgência (pronto-atendimento, pronto-socorro e porta de ugência) realizadas no período.
